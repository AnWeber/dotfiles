# Generated by Powerlevel10k configuration wizard on 2022-10-22 at 16:29 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_SUBSEGMENT_SEPARATOR=' %f| '  # separate segments with a space
  ...
  ###########[ timewarrior: timewarrior tracking status (https://timewarrior.net/) ]############
  # Timewarrior color.
  typeset -g POWERLEVEL9K_TIMEWARRIOR_FOREGROUND=39
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='kubectl|helm|kubens|kubectx|oc|istioctl|kogito|k9s|helmfile|flux|fluxctl|stern|kubeseal|skaffold|kubeimage|k8ty|kubetail|kube|kubeimage'
